...
/**
 * Manages beeps and vibrations for {@link com.meeblue.celsius.ScanActivity}. 管理声音和震动
 */
public final class BeepManager implements MediaPlayer.OnCompletionListener,
		MediaPlayer.OnErrorListener, Closeable {

	private static final String TAG =com.meeblue.celsius.util.android.BeepManager.class.getSimpleName();
